  ...
  return (
    ...
    >
      <div className="flex-1 text-center md:text-left z-[1]">
        ...
        <Link to="contact" smooth spy offset={-80} className="cursor-pointer">
        ...
        <div className="w-[403px] bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-950 p-6">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="bg-blue-800/30 p-2 rounded">
              <a href="https://github.com/sohamjain125">
                <FaGithub size={20} />
              </a>
            </div>

            <div className="bg-blue-800/30 p-2 rounded">
              <a href="https://www.linkedin.com/in/soham-jain-36a134244/">
                <FaLinkedin size={20} />
              </a>
            </div>

            <div className="bg-blue-800/30 p-2 rounded">
              <a href="https://x.com/sohamjain125">
                <FaXTwitter size={20} />
              </a>
            </div>
          </div>
